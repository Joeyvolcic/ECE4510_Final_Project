...
def get_path(positions: list, thetaZ, ids): # position  = [[x1,y1],[x2,y2]]
    ...
    if ids[0][0] == 1: 
        theta1 = math.degrees(np.arctan2(positions[0][1], positions[0][0]))
        theta2 = int(math.degrees(np.arctan2(positions[1][1], positions[1][0])))
    else:
        theta1 = int(math.degrees(np.arctan2(positions[1][1], positions[1][0])))
        theta2 = math.degrees(np.arctan2(positions[0][1], positions[0][0]))
...
def get_path2():
    ...
    for i in range (0,2):
        ...
        path_k2.clear()
        for i in range(0, 30):
            path.append([joint_theta1_array[i], joint_theta2_array[i], 180 + i ])
            path_k.append([joint_theta1_array[i], joint_theta2_array[i], 180 + i])
        ...
        for i in range(0, 30):
            path.append([joint_theta3_array[i], joint_theta4_array[i], 210 + i])
            path_k2.append([joint_theta3_array[i], joint_theta4_array[i], 210 + i ])
        ...
        for i in range(0, 30):
            path.append([joint_theta1_array[i], joint_theta2_array[i], 180 - i ])
            path_k2.append([joint_theta1_array[i], joint_theta2_array[i], 180 - i ])
        
        for i in range(0, 30):
            path.append([joint_theta3_array[i], joint_theta4_array[i], 150 - i])
            path_k.append([joint_theta3_array[i], joint_theta4_array[i], 150 - i ])
...
def get_path3():
    ...
    angle, err, solved, iteration = IK([-250,0,0], [90,90], [joint_length,joint_length], max_iter=1000)
    joint_theta1, joint_theta2 = angle
    joint_theta1_array = np.linspace(90, joint_theta1, 30)
    joint_theta2_array = np.linspace(90, joint_theta2, 30)
    ...
    for i in range(0, 45):
        path.append([90, 90, 180 + i])

    for i in range(0, 30):
        path.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 45])
        path_k.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 45])
    ...
    path_k.clear()
    for i in range(0, 30):
        path.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 135 ])
        path_k.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 135])

    for i in range(29, -1, -1):
        path.append(path_k[i])

    for i in range(135, 215):
        path.append([90, 90, 180 + i])
    path_k.clear()
    for i in range(0, 30):
        path.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 215 ])
        path_k.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 215])
    ...
    path_k.clear()
    for i in range(0, 30):
        path.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 315])
        path_k.append([joint_theta1_array[i], joint_theta2_array[i], 180 + 315])
